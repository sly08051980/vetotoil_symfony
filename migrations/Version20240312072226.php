 ...
 */
final class Version20240312072226 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, race_id INT DEFAULT NULL, user_id INT DEFAULT NULL, prenom_animal VARCHAR(50) NOT NULL, date_naissance_animal DATE DEFAULT NULL, date_creation_animal DATE NOT NULL, date_fin_animal DATE DEFAULT NULL, image_animal VARCHAR(255) DEFAULT NULL, INDEX IDX_6AAB231F6B899279 (patient_id), INDEX IDX_6AAB231F6E59D40D (race_id), INDEX IDX_6AAB231FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE employer (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, adresse_employer VARCHAR(255) NOT NULL, complement_adresse_employer VARCHAR(255) DEFAULT NULL, code_postal_employer VARCHAR(5) NOT NULL, ville_employer VARCHAR(50) NOT NULL, telephone_employer VARCHAR(10) NOT NULL, profession_employer VARCHAR(20) NOT NULL, image_employer VARCHAR(255) DEFAULT NULL, date_creation_employer DATE NOT NULL, UNIQUE INDEX UNIQ_DE4CF066A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
