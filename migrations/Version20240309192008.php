 ...
 */
final class Version20240309192008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, race_id INT DEFAULT NULL, user_id INT DEFAULT NULL, prenom_animal VARCHAR(50) NOT NULL, date_naissance_animal DATE DEFAULT NULL, date_creation_animal DATE NOT NULL, date_fin_animal DATE DEFAULT NULL, image_animal VARCHAR(255) DEFAULT NULL, INDEX IDX_6AAB231F6E59D40D (race_id), INDEX IDX_6AAB231FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
