 ...
 */
final class Version20240307131425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ajouter (id INT AUTO_INCREMENT NOT NULL, jours_travailler VARCHAR(50) NOT NULL, date_entre_employer DATE NOT NULL, date_sortie_employer DATE DEFAULT NULL, date_debut_vacance DATE DEFAULT NULL, date_fin_vacance DATE DEFAULT NULL, debut_repas TIME DEFAULT NULL, date_fin_repas TIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
